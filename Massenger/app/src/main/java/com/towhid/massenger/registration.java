                ...
                auth.createUserWithEmailAndPassword(emaill, Password).addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        if (imageURI != null) {
                            ...
                            imageuri = "https://firebasestorage.googleapis.com/v0/b/massenger-7458f.appspot.com/o/Upload%2Fman.png?alt=media&token=d23c1903-a121-4778-867f-39d0be9915d1";
                            Users users = new Users(id, namee, emaill, Password, imageuri, status);
